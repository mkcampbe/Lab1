...
knitr::opts_knit$set(root.dir = "~/Documents/Lab1/")
```
...
# How do you explain the result for tricky? Tricky is a character data type because if you include a character in the vector, then the whole vector will be the character data type.
```
...
study_sem <- c("Winter 2015","Fall 2015","Winter 2016","Fall 2016","Winter 2017","Fall 2017","Winter 2018","Fall 2018","Winter 2019","Fall 2019")

# Build a vector of the supplements consumed (see powerpoint slides): 
study_supp <- c("BRMPS", "HiMaize260", "inulin", "arabinoxylan", "psyllium", "BRMPS + psyllium", "BRMPS + accessible corn starch", "accessible corn starch", "resistant banana starch", "transition on HiMaize260/switch to BRMPS", "BRMPS + HiMaize260", "LOODAAT potato starch", "oat", "rice")
...
college_age <- c(18,19,20,21,22)
college_age <- as.numeric(college_age)

# Confirm this is numeric
is.numeric(college_age)

# Convert this vector to character:
as.character(college_age)
...
mean(pH_1) == mean(pH_2) #these mean values are not equal
```
